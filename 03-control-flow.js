...
// ─────────────────────────────────
// 5. Short-Circuit Evaluation -- JavaScript จะหยุดประเมินเมื่อรู้ผลลัพธ์แล้ว
// ─────────────────────────────────
...
// Optional Chaining explanation (เขียนรวมบรรทัดกัน error)
// admin?.name = ถ้า admin ไม่เป็น null/undefined จะเข้าถึง name ได้
// ถ้าเป็น null จะไม่ error และคืนค่า undefined
